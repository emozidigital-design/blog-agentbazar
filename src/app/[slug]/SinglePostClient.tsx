    ...
    <>
      ...
      <div className="stay-connected-main">
        ...
        <div className="social-links-row">
          <Link href="https://www.facebook.com/agentbazar" target="_blank" className="social-link-item" style={{ fontSize: 14 }}>Facebook</Link>
          <Link href="https://x.com/AgentBazar" target="_blank" className="social-link-item" style={{ fontSize: 14 }}>Twitter/X</Link>
          <Link href="https://www.instagram.com/agentbazar.in/" target="_blank" className="social-link-item" style={{ fontSize: 14 }}>Instagram</Link>
          <Link href="https://www.youtube.com/@agentbazar6074" target="_blank" className="social-link-item" style={{ fontSize: 14 }}>YouTube</Link>
        </div>
        <div className="channel-btns-row">
          ...
          <Link href="https://t.me/AgentBazarB2b" target="_blank" className="channel-btn telegram">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
